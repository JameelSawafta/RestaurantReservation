...
public class EmployeesController : Controller
{
    ...
    {
        // add the logic to get all employees with pagination
        if (pageNumber < 1 || pageSize < 1)
            return BadRequest("PageNumber and PageSize must be greater than 0.");

        // same as customer controller
    ...
    [HttpPut("{id}")]
    public async Task<EmployeeDto> Update(Guid id, UpdateEmployeeDto employeeDto)
    {
